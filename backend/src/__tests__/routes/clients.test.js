...
describe('Client Routes', () => {
  ...
  describe('POST /api/clients', () => {
    ...
    test('should handle error when retrieving created client', async () => {
      mockDb.run.mockImplementation(function(query, params, callback) {
        this.lastID = 1;
        callback.call(this, null);
      });
  ...
  describe('PUT /api/clients/:id', () => {
    ...
    test('should handle error when retrieving updated client', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });
    ...
    test('should update both name and description', async () => {
      const updatedClient = { id: 1, name: 'New Name', description: 'New Desc' };
  ...
  describe('DELETE /api/clients/:id', () => {
    ...
    test('should handle database error when checking client exists for delete', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(new Error('Database error'), null);
      });
